			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"slewmwaste-display": {
								"semanticObject": "slewmwaste",
								"action": "display",
								"description": "Waste App",
								"title": "Waste App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sl.ewmwaste",
									"url": sap.ui.require.toUrl("sl/ewmwaste")
								}
							}
						}
					}
